...
test("CLI exposes the complete required command set and marks Phase 7 commands read-only", () => {
  assert.deepEqual(UPGRADE_GOVERNANCE_CLI_COMMANDS_V1, [
    ...
    "initialize-governance-lifecycle-registry-v2", "create-governance-timing-profile-v1",
    "create-timing-policy-change-v1", "approve-timing-policy-change-v1",
    "cancel-timing-policy-change-v1", "expire-timing-policy-change-v1",
    "queue-timing-policy-change-v1", "execute-timing-policy-change-v1",
    "create-council-rotation-v2", "approve-council-rotation-v2",
    "cancel-council-rotation-v2", "expire-council-rotation-v2",
    "queue-council-rotation-v2", "execute-council-rotation-v2",
    "create-target-authority-handoff-v2", "approve-target-authority-handoff-v2",
    "cancel-target-authority-handoff-v2", "expire-target-authority-handoff-v2",
    "queue-target-authority-handoff-v2", "execute-target-authority-handoff-v2",
    "create-bootstrap-activation-v2", "approve-bootstrap-activation-v2",
    "cancel-bootstrap-activation-v2", "expire-bootstrap-activation-v2",
    "queue-bootstrap-activation-v2", "execute-bootstrap-activation-v2",
  ]);
  ...
  assert.deepEqual(RELEASE1_PUBLIC_SCHEMA_V1.instructionTags, {
    ...
    InitializeGovernanceLifecycleRegistryV2: 82,
    CreateGovernanceTimingProfileV1: 83,
    CreateTimingPolicyChangeProposalV1: 84,
    ApproveTimingPolicyChangeProposalV1: 85,
    CancelTimingPolicyChangeProposalV1: 86,
    ExpireTimingPolicyChangeProposalV1: 87,
    QueueTimingPolicyChangeProposalV1: 88,
    ExecuteTimingPolicyChangeProposalV1: 89,
    CreateCouncilRotationProposalV2: 90,
    ApproveCouncilRotationProposalV2: 91,
    CancelCouncilRotationProposalV2: 92,
    ExpireCouncilRotationProposalV2: 93,
    QueueCouncilRotationProposalV2: 94,
    ExecuteCouncilRotationProposalV2: 95,
    CreateTargetAuthorityHandoffProposalV2: 96,
    ApproveTargetAuthorityHandoffProposalV2: 97,
    CancelTargetAuthorityHandoffProposalV2: 98,
    ExpireTargetAuthorityHandoffProposalV2: 99,
    QueueTargetAuthorityHandoffProposalV2: 100,
    ExecuteTargetAuthorityHandoffProposalV2: 101,
    CreateBootstrapActivationProposalV2: 102,
    ApproveBootstrapActivationProposalV2: 103,
    CancelBootstrapActivationProposalV2: 104,
    ExpireBootstrapActivationProposalV2: 105,
    QueueBootstrapActivationProposalV2: 106,
  ...
  assert.deepEqual({
    ...
    GovernanceTimingProfileV1: RELEASE1_PUBLIC_SCHEMA_V1.accountLengths.GovernanceTimingProfileV1,
    TimingPolicyChangeProposalV1: RELEASE1_PUBLIC_SCHEMA_V1.accountLengths.TimingPolicyChangeProposalV1,
    CouncilRotationProposalV2: RELEASE1_PUBLIC_SCHEMA_V1.accountLengths.CouncilRotationProposalV2,
    TargetAuthorityHandoffProposalV2: RELEASE1_PUBLIC_SCHEMA_V1.accountLengths.TargetAuthorityHandoffProposalV2,
    BootstrapActivationProposalV2: RELEASE1_PUBLIC_SCHEMA_V1.accountLengths.BootstrapActivationProposalV2,
  }, {
    GovernanceLifecycleRegistryV2: 256,
    GovernanceTimingProfileV1: 384,
    TimingPolicyChangeProposalV1: 512,
    CouncilRotationProposalV2: 512,
    TargetAuthorityHandoffProposalV2: 1_280,
    BootstrapActivationProposalV2: 1_280,
  });
