...
const cases: readonly CodecCase[] = [
  ...
  [52, 223, { expectedProposalDigest: h(1), expectedBridgeObservationDigest: h(2), expectedGateEpoch: 3n, expectedTargetNonce: 4n, expectedDeploymentDigest: h(5), expectedReceiptDigest: h(6), envelope }, authority.encodeExecuteBootstrapActivationV1 as never, authority.decodeExecuteBootstrapActivationV1],
