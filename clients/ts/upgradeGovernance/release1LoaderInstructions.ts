...
export function buildExtendTargetV1Instruction(programId: PublicKey, a: ExtendTargetV1Accounts, v: ExtendTargetV1): TransactionInstruction { return ix(programId, [ws(a.payer), ro(a.controllerConfig), ro(a.protocolGate), rw(a.proposal), ro(a.prestateCheckpoint), rw(a.targetProgramdata), rw(a.targetProgram), ro(a.authorityPda), ro(a.upgradeableLoader), ro(a.systemProgram), ro(a.rentSysvar), ro(a.instructionsSysvar)], encodeExtendTargetV1(v)); }
